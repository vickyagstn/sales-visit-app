...
<Link to="/sales" style={navStyle('/sales')}>
  <span style={{fontSize:18}}>👥</span>
  <span style={labelStyle('/sales')}>Sales</span>
</Link>

<Link to="/visits" style={navStyle('/visits')}>
  <span style={{fontSize:18}}>📅</span>
...
<Link to="/ai-analysis" style={navStyle('/ai-analysis')}>
  <span style={{fontSize:18}}>🤖</span>
  <span style={labelStyle('/ai-analysis')}>AI</span>
</Link>

<Link to="/reports" style={navStyle('/reports')}>
  <span style={{fontSize:18}}>📈</span>
